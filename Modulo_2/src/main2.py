...
# query = "mouse+verticale"
# url = f"https://www.amazon.it/s?k={query}&crid=1UXYQBEK61PDI&qid=1728849889&sprefix=mouse%2Caps%2C186&ref=sr_pg_1"
...
#   product_element = html.find("div",{"data-asin":"B09C1BQ1YX"})
#   product_title = product_element.find("span", class_ = "a-size-base-plus a-color-base a-text-normal").string
